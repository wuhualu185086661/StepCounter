...
public class StepDcretor extends Activity implements SensorEventListener {  
                    ...
                    if (average >= maxValue) {  
                        ...
                        if (betweentime >= minTime && betweentime < maxTime) {  
                            ...
                            if (CountTimeState == 0) {  
                                ...
                                CountTimeState = 1;  
                                Log.v(TAG, "开启计时器");  
                                Toast.makeText(this, "开启计时器", Toast.LENGTH_SHORT).show();
                            } else if (CountTimeState == 1) {  
                                TEMP_STEP++;  
                                Log.v(TAG, "计步中 TEMP_STEP:" + TEMP_STEP); 
                                Toast.makeText(this, "计步中 TEMP_STEP:", Toast.LENGTH_SHORT).show();
                                ...
                                TimerTask task = new TimerTask() {  
                                    public void run() {  
                                        if (lastStep == CURRENT_SETP) {  
                                            ...
                                            Toast.makeText(StepDcretor.this, "停止计步: ", Toast.LENGTH_SHORT).show();
                                        } else {  
    ...
    class TimeCount extends CountDownTimer {  
        ...
        public void onFinish() {  
            ...
            CountTimeState = 2;  
            Log.v(TAG, "计时正常结束");  
            Toast.makeText(StepDcretor.this, "计时正常结束 ", Toast.LENGTH_SHORT).show();
        }  
